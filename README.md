...
> 更新时间: 2026-08-25 09:47 | 岗位总数: **365**
...
| 方向 | 说明 | 岗位数 |
| --- | --- | --- |
| 大模型/AI测试 | 大模型评测、算法测试、AI质量保障 | 94 |
| 测试开发(AI方向) | AI方向的测试开发、评测平台、自动化框架 | 108 |
| Agent评测 | Agent/大模型效果评测、Benchmark建设 | 81 |
| AI/Agent产品 | AI策略产品、Agent产品、AIGC产品 | 82 |
...
### [小红书](jobs/小红书.md)（7 个岗位）

_Agent评测 5 / AI/Agent产品 2_
...
### [携程](jobs/携程.md)（171 个岗位）

_测试开发(AI方向) 68 / 大模型/AI测试 58 / AI/Agent产品 34 / Agent评测 11_
...
### [科大讯飞](jobs/科大讯飞.md)（13 个岗位）

_大模型/AI测试 11 / 测试开发(AI方向) 1 / Agent评测 1_
...
### [阿里巴巴](jobs/阿里巴巴.md)（25 个岗位）

_测试开发(AI方向) 13 / 大模型/AI测试 5 / AI/Agent产品 4 / Agent评测 3_
...
*数据自动采集，更新于 2026-08-25 09:47。仅供求职参考。*
