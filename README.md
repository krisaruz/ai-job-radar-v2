...
> 更新时间: 2026-08-10 10:31 | 岗位总数: **202**
...
| 方向 | 说明 | 岗位数 |
| --- | --- | --- |
| 大模型/AI测试 | 大模型评测、算法测试、AI质量保障 | 36 |
| 测试开发(AI方向) | AI方向的测试开发、评测平台、自动化框架 | 47 |
| Agent评测 | Agent/大模型效果评测、Benchmark建设 | 70 |
| AI/Agent产品 | AI策略产品、Agent产品、AIGC产品 | 49 |
...
_测试开发(AI方向) 1 / Agent评测 1 / AI/Agent产品 1_
...
### [快手](jobs/快手.md)（20 个岗位）

_Agent评测 14 / 大模型/AI测试 3 / AI/Agent产品 2 / 测试开发(AI方向) 1_
...
### [携程](jobs/携程.md)（30 个岗位）

_测试开发(AI方向) 12 / Agent评测 6 / 大模型/AI测试 6 / AI/Agent产品 6_
...
### [百度](jobs/百度.md)（22 个岗位）

_AI/Agent产品 12 / Agent评测 6 / 测试开发(AI方向) 3 / 大模型/AI测试 1_
...
_测试开发(AI方向) 14 / 大模型/AI测试 4 / AI/Agent产品 4 / Agent评测 2_
...
*数据自动采集，更新于 2026-08-10 10:31。仅供求职参考。*
